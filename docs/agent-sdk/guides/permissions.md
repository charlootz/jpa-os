...
3. **[Hooks](https://platform.claude.com/docs/en/agent-sdk/hooks)** \- Fine-grained control over every tool execution with custom logic
...
- [Hooks Guide](https://platform.claude.com/docs/en/agent-sdk/hooks) \- Learn how to implement hooks for fine-grained control over tool execution
