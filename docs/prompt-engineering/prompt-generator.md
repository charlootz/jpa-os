...
Note that to run the Colab notebook, you will need an [API key](https://platform.claude.com/settings/keys).
...
\\
Get inspired by a curated selection of prompts for various tasks and use cases.](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/be-clear-and-direct) [Prompt library\\
\\
