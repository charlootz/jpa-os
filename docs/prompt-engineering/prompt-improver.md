...
Our prompt improver is compatible with all Claude models, including those with extended thinking capabilities. For prompting tips specific to extended thinking models, see [here](https://platform.claude.com/docs/en/build-with-claude/extended-thinking).
...
[Prompt library\\
\\
Get inspired by example prompts for various tasks.](https://platform.claude.com/docs/en/resources/prompt-library/library) [GitHub prompting tutorial\\
\\
...
\\
Use our evaluation tool to test your improved prompts.](https://platform.claude.com/docs/en/test-and-evaluate/eval-tool)
